...
import {NotificationHelperComponent} from './view/shared/helper/notification-helper/notification-helper.component';
import {
...
import {RamassageEffect} from "@app/core/state/ramassage/ramassage.effects";
import {ramassageReducer} from "@app/core/state/ramassage/ramassage.reducer";
import {
  ListVendorRamassageDoneComponent
} from './view/modules/vendor/colis/list-vendor-rammage-done/list-vendor-ramassage-done.component';
import {ramassageDoneReducer} from "@app/core/state/ramassage-done/ramassage-done.reducer";
import {RamassageDoneEffect} from "@app/core/state/ramassage-done/ramassage-done.effects";
import {
  DashboardSectionTitleComponent
} from './view/shared/widgets/pieces/dashboard-section-title/dashboard-section-title.component';
import {
  VendorStatisticsCardComponent
} from './view/shared/widgets/cards/vendor-statistics-card/vendor-statistics-card.component';
import {VendorStatisticsEffect} from "@app/core/state/vendor-statistics/vendor-statistics.effect";
import {VendorStatisticsReducer} from "@app/core/state/vendor-statistics/vendor-statistics.reducer";
...
@NgModule({
  ...
  imports: [
    ...
    StoreModule.forRoot({
        ...
        city: cityReducer,
        colis: colisReducer,
        ramassage: ramassageReducer,
        ramassageDone: ramassageDoneReducer,
        vendorStatistics: VendorStatisticsReducer
      },
      {}
    ),
    ...
    EffectsModule.forRoot([
      ProfileEffect, CityEffect, ColisEffect,
      RamassageEffect, RamassageDoneEffect, VendorStatisticsEffect
    ]),
