...
import {createColis, createColisSuccess} from "@app/core/state/colis/colis.actions";
...
export class AddColisVendorFormComponent implements OnInit {
  ...
  constructor(protected cityStore: Store<CityStore>,
              ...
              protected statisticsStoreStore: Store<VendorStatisticsStore>,
  ...
  onSubmit() {
    ...
    if (this.colisVendorValidator.form.valid) {
      ...
      this.notificationService.notifyWarning('Veuillez remplir tous les champs obligatoires !');
    }
  }
